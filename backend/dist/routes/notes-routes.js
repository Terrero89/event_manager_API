...
// event routes --> api/v1/
router.get("/", auth_util_1.verifyToken, note_controller_1.getNotesController); // get all todos route
router.get("/:id", auth_util_1.verifyToken, note_controller_1.getNoteController); // get all todo route
